...
bc. val corpus: Agent[String, String] = new Corpus
...
<img src="com.quui.tm2.scala/files/tm2-setup.png" width="400px"/>

For the complete run, an overview page with results is generated:

<img src="com.quui.tm2.scala/files/tm2-result.png" width="600px"/>
